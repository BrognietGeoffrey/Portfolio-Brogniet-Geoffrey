...
const Work = () => (
    ...
    <Layout title="Alumni" style={{ position: 'relative' }}>
      <Container maxW="container.lg">
        ...
        <P>L'atelier organisé par l'EPHEC Alumni avait pour vocation d'amener des témoignages d'anciens étudiants de l'EPHEC. Nous avons pu voir beaucoup d'anciens étudiants nous parler de leurs entreprises, leurs réussites, leurs échecs.</P>
