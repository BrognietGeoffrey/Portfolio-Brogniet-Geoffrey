...
const Work = () => (
    ...
    <Layout title="Formation FullStack">
      <Container maxW="container.lg">
        ...
        <P>
          La formation "Passez au Full Stack avec Node.js, Express et MongoDB" proposée également par OpenClassRoomsa été aussi d'une grande valeur ajoutée en parallèle de la formation de l'EPHEC.
        ...
        <P>Cela m'a également fort aidé à mieux comprendre le Full Stack et surtout le backend où j'avais encore quelques difficultés.</P>
