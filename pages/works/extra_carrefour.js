...
const Work = () => (
    ...
    <Layout title="Job étudiant">
      <Container maxW="container.lg">
        ...
        <P>Ce travail étudiant m'a permis d'acquérir beaucoup de compétences dans ma vie professionnelle comme la communication, la gestion du stress, la gestion des imprévus, les conflits entre collègues, la quantité de travail surprenantes et encore plein de compétence.</P>
        <P> Toutes ces compétences sont un plus non-mesurable en tant que futur informaticien où généralement la communication n'est pas son plus grand atout. J'ai beaucoup appris et je n'en garde que des bons souvenirs. </P>
