  ...
  const Work = () => (
    ...
    <Layout title="Formation React Native">
      <Container maxW="container.lg">
        ...
        <P>
        La formation "Développez une application mobile React Native" proposée également par Openclassrooms a été une grande valeur ajoutée en parallèle de la formation de l'EPHEC. En effet, cette formation m'a aidé à me préparer pour le cours "Projet d'intégration", pour lequel moi-même et mon groupe avons utilisé React Native pour créer notre application mobile. </P>
...
<P>Encore une fois, j'ai énormément apprécié cette formation créée par Openclassrooms. Elle a véritablement été à la hauteur, et m'a permis de pouvoir rapidement concrétiser une application mobile (certe, basique dans un premier temps) pour le projet d'intégration, et d'amélioler celle-ci au fur et à mesure.</P>
