...
const Work = () => (
    ...
    <Layout title="SIEP" display="flex">
      <Container maxW='container.lg'>
        ...
        Etant en binôme avec Matthieu Luycks, je pense que nous avons donné tout ce que nous avions en notre possession pour motiver les potentiels candidats à se laisser guider vers nos études, comme nous avions bien pu les vendre. Une description objective des cours, du large panel informatique que propose l'EPHEC et de ses qualités,
        nous avons tout donné durant les 4 heures où nous représentions l'EPHEC.
        </P>
        <P>Le seul regret que j'ai par rapport à cette activité à été le très léger intéret des étudiants présents. Sur les 4 heures où nous étions présents, nous avons pu répondre aux question d'une dizaine de personnes, sans compter la majeure partie des questions de la part des étudiants qui pensaient être au stand pour la comptabilité à l'EPHEC. Mis à part ça, les quelques personnes s'intéressant à l'informatique avaient l'air vraiment satisfaites de nos explications, elles ont eu les réponses aux questions qu'elles se sont posées, et - j'espère - en sont repartis en ayant la potentialité de faire leurs études à l'EPHEC dans un coin de la tête.</P>
        ...
        <Heading as="h4" fontSize={16} my={6}>
          <Center>Les preuves de la réalisation pour cet emploi</Center>
        </Heading>
